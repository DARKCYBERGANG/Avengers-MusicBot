...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name =  "Avengers-Music Player"
    usar = user
    wew = usar.id
    try:
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>Avengers-Music Player joined your chat</b>",
                              )
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @Avengera_Player to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="▶️ **Playing** here the song requested by {} via Avengers-Music 😜".format(
...
async def deezer(client: Client, message_: Message):
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                                  "\n\nOr manually add @Avengers_Player to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        appendable = [s_name, r_by, loc]
        qeue.append(appendable)
        await res.edit_text(f"✯Avengers-Music✯= #️⃣ Queued at position {position}")
    else:
        await res.edit_text("✯Avengers-Music✯=▶️ Playing.....")
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> Avengers-Music Player not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    requested_by = message_.from_user.first_name
    chat_id=message_.chat.id
         ...
         [   
             ...
             [
               InlineKeyboardButton(
                   ...
                   url='https://t.me/AkCrazytechGiveaways')
             ],
             [       
               InlineKeyboardButton(
                   text="❌ Close",
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯Avengers-Music✯=#️⃣ Queued at position {position}",
